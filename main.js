...
checkbox.addEventListener('change',function(){
    if(this.checked){
        ...
        document.querySelector('label i').classList.add('fa-moon');
        document.querySelector('label i').classList.remove('fa-sun');
        
    }
    else{
        document.documentElement.setAttribute('data-theme', 'light');
        document.querySelector('label i').classList.add('fa-sun');
        document.querySelector('label i').classList.remove('fa-moon');
